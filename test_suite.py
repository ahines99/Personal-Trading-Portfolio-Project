...
def generate_ml_signal(data, forward_window=21, min_train_days=252,
                       ml_blend=0.70, mom_blend=0.30, **model_kwargs):
    ...
    ml_signal = wf.fit_predict(data["panel"], labels)
...
def main():
    ...
    for i, (test_name, signal_kwargs, pk_override) in enumerate(all_tests):
        ...
        signal, wf = generate_ml_signal(
            ...
            ml_blend=ml_blend, mom_blend=mom_blend, **sig_params,
        )
